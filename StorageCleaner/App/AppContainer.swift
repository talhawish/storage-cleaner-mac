...
private struct DemoStorageScanner: StorageScanning {
    ...
    static let allFindings: [StorageFinding] = [
        demo(.xcodeArtifacts, .appleDevelopment, bytes: 18_535_280_640, items: 412, safety: .review),
        demo(.iosDeviceSupport, .appleDevelopment, bytes: 20_521_336_832, items: 4, safety: .safe),
        ...
        demo(.pythonDependencies, .otherCaches, bytes: 2_040_109_056, items: 91, safety: .review),
        ...
        demo(.phpDependencies, .otherCaches, bytes: 1_395_864_576, items: 52, safety: .review),
        demo(.rubyDependencies, .otherCaches, bytes: 1_019_215_872, items: 35, safety: .review),
        demo(.dotnetDependencies, .otherCaches, bytes: 1_610_612_736, items: 61, safety: .review),
        demo(.gradleDependencies, .otherCaches, bytes: 2_362_556_416, items: 80, safety: .review),
        ...
        demo(.orphanedAppCaches, .systemJunk, bytes: 1_073_741_824, items: 39, safety: .safe),
        ...
        demo(.oldCrashReports, .systemJunk, bytes: 24_117_248, items: 33, safety: .safe),
